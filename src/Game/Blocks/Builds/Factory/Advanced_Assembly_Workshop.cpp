...
Advanced_Assembly_Workshop::Advanced_Assembly_Workshop() : AFactory()
{
    ...
    _AcceptedItems.push_back(Item("Stabilized_Radioactive_Mater"));
    ...
    _AcceptedItems.push_back(Item("Condensed_Plasma"));
    ...
    _AcceptedItems.push_back(Item("Conductive_Socket"));
    ...
    _AcceptedItems.push_back(Item("High_Power_EMP_Charge"));
